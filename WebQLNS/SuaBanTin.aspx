<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SuaBanTin.aspx.cs" Inherits="WebQLNS.SuaBanTin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="Scripts/ckeditor/ckeditor.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <h2>Cập nhật bản tin</h2>
    <hr />
    ...
    <div class="row mb-2">
        ...
        <div class="col-md-10">
             <asp:FileUpload ID="FHinh" runat="server" /> <br />
    ...
    <div class="row mb-2">
     ...
     <div class="row mb-2">
        ...
        <div class="col-md-10">
             <asp:Button ID="btSave" runat="server" Text="Cập nhật" CssClass="btn btn-primary" OnClick="btSave_Click" />
